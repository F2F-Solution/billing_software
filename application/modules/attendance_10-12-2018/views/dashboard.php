            ...
            <div class="col-md-6">
                <div class="panel panel-primary noborder">
                    <div class="panel-heading  panel-back  noborder">
                        ...
                        <div class="media-body1"><a href="#"class="pull-right btn btn-success">View All</a><br />
                            <h5 class="md-title nomargin">TODAY ABSENTIES lIST</h5>                        </div><!--<media-body >-->
                        <hr>
                        <div class="clearfix mt20">
                            <div id="parent">
...
//
                                        ...
                                        if (isset($users_data) && !empty($users_data)) {
                                            ...
                                            foreach ($users_data as $key => $list) {
                                                ?>
                                                <tr>
                                                    <td class="qty_align"><?php echo ucwords($list['username']); ?></td>
                                                    <!--<td class="qty_align">fever</td>-->
                                                    <td class="qty_align"><?php echo date('d-m-Y'); ?></td>
                                                    <td class="qty_align"><?php echo $list['status']; ?></td>
                                                </tr>
                                                <?php
                                            }
                                        }
...
//                                        }
            ...
            <div class="col-md-6">
                <div class="panel panel-dark noborder">
                    <div class="panel-heading panel-red noborder">
                        <div class="media-body1"><a href="#"class="pull-right btn btn-success">View All</a><br />
                            <h5 class="md-title nomargin">LATE COMMERS</h5>
                        </div><!-- media-body >-->
                        <hr>
                        <div class="clearfix mt20">
                            <div id="parent">
                                <table class="table table-bordered fixTable margin0">
                                    <thead>
                                    <th class="st qty_align">Name</th>
                                    <th class="st qty_align">In-Time</th>
                                    <th class="st qty_align">Out-Time</th>
                                    <th class="st qty_align">Total hours</th>
                                    </thead>
                                    <tbody>
                                        <?php
                                        if (isset($report['stock']) && !empty($report['stock'])) {
                                            foreach ($report['stock'] as $stock) {
                                                ?>
                                                <tr>
                                                    <td class="st qty_align">sample</td>
                                                    <td class="st qty_align">9.10AM</td>
                                                    <td class="st qty_align">7.00</td>
                                                    <td class="st qty_align">10Min</td>
                                                </tr>
                                                <?php
                                            }
                                        } else {
