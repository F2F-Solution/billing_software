            ...
            <div class="" style="">
                ...
                if (isset($users_data)) {
                    foreach ($users_data as $dates => $users_list) {
                        ...
                        ?>
                        <div> <h5>Daily Attendance <?php echo date('d-m-Y', strtotime($dates)); ?> (<?php echo $nameOfDay; ?>)</h5>
...
//print_r($shifts);
                                    ...
                                    <tr>
                                       ...
                                       <!-- <td class="action-btn-align">Shift</td>-->
                                        ...
                                        <?php if (isset($users_data[$dates]['holidays']) && !empty($users_data[$dates]['holidays'])) {
                                            ?>
                                        <tr><td colspan='7'><center><?php echo $users_data[$dates]['holidays'][0]['reason'] . "  Holiday"; ?></center></td></tr>
                                <?php } else { ?>
                                        ...
                                        foreach ($users_data[$dates]['users'] as $key => $list) {
                                            ...
                                            <tr>
                                               ...
                                               <!-- <td class="action-btn-align"><?php echo $list['shift_name']; ?></td>-->
                                                <td class="action-btn-align"><?php echo $list['shift_in']; ?></td>
                                                <td class="action-btn-align"><?php echo $list['shift_out']; ?></td>
                                                <td class="action-btn-align time_calc_in_time"><?php echo $list['in']; ?></td>
                                                <td class="action-btn-align time_calc_out_time"><?php
                                                    ...
                                                    ?></td>
                                                <td class="action-btn-align time_calc_work_time"><?php echo $list['total_duration']; ?></td>
                                                <td class="action-btn-align"><?php echo $list['ot']; ?></td>
                                                <td class="action-btn-align"><?php echo $list['over_all_duration']; ?></td>
                                                <td class="action-btn-align"><?php echo $list['late_by']; ?></td>
                                                <td class="action-btn-align"><?php echo $list['early_going']; ?></td>
            ...
            <div class="action-btn-align mb-10" style="margin-top:7px;">
                ...
                <a href="http://localhost/f2fprojects/trunk/billing_softv2/attendance/monthly_attendance" title="Back"><input type="button" class="btn btn-info btn-rounded" value="Back" id="back_btn" autocomplete="off" ></a>
