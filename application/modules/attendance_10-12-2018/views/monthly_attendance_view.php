...
<style type="text/css">
    ...
    .tamount-right tr td:nth-child(5) {
        text-align: center;
    }
</style>
...
<div class="contentinner">
    <div class="media mt--20">
        <h4 class="widgettitle">Monthly Attendance View -
            <?php
...
//Iterate over the DatePeriod instance
        ...
        <div class="panel-body mt-top5">
            <h5 class="emp_info">
                ...
                <span class=""><span class="emp_title"><b>Employee Name</b></span> :<?php echo $name[0]['first_name']; ?>&nbsp;<?php echo $name[0]['last_name']; ?></span>

                <span class=""><span class="emp_title"><b style="margin-left:-113px;">Department</b></span> : <?php echo $dept[0]['dep_name']; ?></span>

                <span class=""><span class="emp_title"><b>Designation</b></span> : <?php echo $dept[0]['des_name']; ?></span>
            ...
            <table width="100%" border="0" class="">
                <tbody>
                    ...
                    <tr class="no-display">
                        ...
                        <td width="40%">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id='from_date'  class="form-control datepicker" name="from_date_picker" value="<?php echo(!empty($from_date_picker) ? date('d-m-Y', strtotime($from_date_picker)) : date('d-m-Y')); ?>" placeholder="dd-mm-yyyy" >
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label class="control-label">To Date</label>
                                    <input type="text"  id='to_date' class="form-control datepicker" name="to_date_picker" value="<?php echo(!empty($to_date_picker) ? date('d-m-Y', strtotime($to_date_picker)) : date('d-m-Y')); ?>"   placeholder="dd-mm-yyyy" >
                                </div>
                            </div>
                        </td>
                        ...
                        <td><input type="submit" name="go" value="Go" id="go" class="btn btn-warning border4" style="margin-left:-55px;">
                        </td>
                <input type="hidden" name="start_date" id="start_date" value="<?= $start_date ?>">
                <input type="hidden" name="user_id" value="<?= $user_id ?>" class="emp_id">
        ...
        <div class="panel-body mt-top5">
            ...
            <div class="scroll_bar">
                <table class="table table-bordered sortable table-striped table-bordered responsive dataTable no-footer dtr-inline
                  ...
                  <!--  <caption>&nbsp;&nbsp;&nbsp;&nbsp;<span class="btn-rounded holiday_class" style="background-color:#F2DCE6;">&nbsp;&nbsp;&nbsp;&nbsp;</span> - Holiday

                        <span class="btn-rounded fd_leave_class"style="background-color:#99CCFF;">&nbsp;&nbsp;&nbsp;&nbsp;</span> - Full Day Leave&nbsp;&nbsp;&nbsp;&nbsp;

                        <span class="btn-rounded hd_leave_class " style="background-color:#CCCCCC;">&nbsp;&nbsp;&nbsp;&nbsp;</span> - Half Day Leave&nbsp;&nbsp;&nbsp;&nbsp;

                        <span class="btn-rounded permission_class" style="background-color:#FFCC66;">&nbsp;&nbsp;&nbsp;&nbsp;</span> - Permission&nbsp;&nbsp;&nbsp;&nbsp;

                        <span class="btn-rounded compoff_class" style="background-color:#CC99CC;">&nbsp;&nbsp;&nbsp;&nbsp;</span> - Compoff&nbsp;&nbsp;&nbsp;&nbsp;

                        <span class="btn-rounded lop_class " style="background-color:#CCFFFF;">&nbsp;&nbsp;&nbsp;&nbsp;</span> - LOP&nbsp;&nbsp;&nbsp;&nbsp;

                        <span class="btn-rounded on_duty_class"style="background-color:#99CC99;;">&nbsp;&nbsp;&nbsp;&nbsp;</span> - On-duty&nbsp;&nbsp;&nbsp;&nbsp;

                        <span class="btn-rounded earned_leave_class " style="background-color:#D5D1A4;">&nbsp;&nbsp;&nbsp;&nbsp;</span> - Earned Leave&nbsp;&nbsp;&nbsp;&nbsp;

                        <span class="btn-rounded inactive_class "style="background-color:#E0C3A8;">&nbsp;&nbsp;&nbsp;&nbsp;</span> - Inactive status&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <tbody>
                        ...
                        for ($k = 0; $k <= count($user_days) - 1; $k++) {
                            ...
                            if ($leave_type == 4 || $leave_type == 2) {
                                ...
                                if (isset($attendance[$day_value]['attendance_date'])) {
                                    ...
                                    if ($day_value == $attendance[$day_value]['attendance_date']) {
                                        ...
                                        $dates = $attendance[$day_value]['attendance_date'];
                                ...
                                $p_holidays = "";
                                if ($attendance[$day_value]["in"] == "") {
                                    $this->db->where('holiday_from', $dates);
                                    $this->db->or_where('holiday_to', $dates);
                                    $holidays_data = $this->db->get('public_holidays')->result_array();
                                    $holidays_data = count($holidays_data);
                                ...
                                <tr>
                                    ...
                                    if ($i == 1) {
                                        ...
                                        if ($attendance[$day_value]["in"] != "00:00:00")
                                            echo "<td class='time_calc time_calc_in_time'>" . $attendance[$day_value]["in"] . "</td>";
                                        else
                                            echo "<td class='time_calc time_calc_in_time'></td>";
                                        ...
                                        $cde = $this->attendance_model->chk_date_exits($chk_date);
                                        if ($cde != '') {


                                            if ($cde == "PH") {
                                                echo "<td colspan='4' class='time_calc green'><b>Public Holiday</b></td>";
                                            } elseif ($cde == 'H') {
                                                echo "<td colspan='4' class='time_calc yellow'><b>Holiday</b></td>";
                                            } elseif ($cde == 'A') {
                                                echo "<td colspan='4' class='time_calc red'><b>Absent</b></td>";
                                            } else {
                                                echo "<td colspan='4' class='time_calc '>-</td>";
                                            }
                                        }
                                    }
                                    ?>
                            ...
                            <?php if ($cde == '') { ?>
                                <td   class="center <?= $style ?>">
                                    ...
                                    if ($i == 1) {
                                        ...
                                        if ($attendance[$day_value]["in"] != "00:00:00")
                                            echo "<span class='time_calc time_calc_out_time'>" . $attendance[$day_value]["out"] . "</span>";
                                        else
                                            echo "<span class='time_calc time_calc_out_time'></span>";
                                        ...
                                        if (isset($break) && !empty($break)) {
                                            ...
                                            foreach ($break as $br) {
                                                ...
                                                if ($br["in_time"] != "00:00:00") {
                                                    ...
                                                    $total_break_time_perday+=$break_diff;
                                                }
                                                ...
                                                /* if ($br["in_time"] != "00:00:00") {
                                                  ...
                                                  echo '&nbsp;<a href="javascript:void(0);" title="Add" class="btn btn-danger add_row">+</i></a>';

                                                  echo "<br>";
                                                  } else {

                                                  echo '&nbsp;<a href="javascript:void(0);" title="Remove" class="btn btn-danger remove_row">-</a>';
                                                  }

                                                  $j++;
                                                  } */
                                            }
                                            $minutes = $total_break_time_perday;
                                            $total_break_hours = floor($minutes / 60) . ':' . ($minutes - floor($minutes / 60) * 60);
                                            echo "<span class='break_time'>" . $total_break_hours . "</span>";
                                        } else {
                                            $enter = 1;
                                            ...
                                            echo form_input($br_out);
                                            echo "</span>";
                                            echo '&nbsp;<a href="javascript:void(0);" title="Add" class="btn btn-danger add_row">+</a>';
                                        }
                                    } else {
                                        $enter = 1;
                                        echo "<span class='break_time'></span><span class='break_to_clone'>";
                                ...
                                <td  class="time_calc_work_time center total_hours <?= $style ?>">
                            ...
                            <td class="center action">
                                ...
                                ?>
                                <span class='badge bg-green view_day_log' day_value="<?php echo $day_value; ?>"  style="cursor: pointer;" title="log">log</span>
                                <!--<a href='javascript:void(0)' data-toggle="tooltip" class="tooltips btn btn-info btn-xs edit" title="" data-original-title="Edit"><span class="fa fa-edit "></span></a>-->

                                <?php
                                $v = 1;
                                ?>
                                <a href='javascript:void(0)' class="cancel btn btn-danger " data-toggle="tooltip"  title="" data-original-title="Cancel"><span class="fa fa-close "></span></a>
                                <?php
                                $v = 1;
                                ?>
                                <!--<a href='javascript:void(0)' class="cancel btn btn-danger btn-rounded">Cancel</a>-->
...
<div class="action-btn-align" style="margin-top:7px;">
    <input type="submit" name="update" value="save" class="btn btn-primary btn-rounded save" title="save">
        ...
        <div class="modal-content"style="overflow-y:auto; height:600px;">
            ...
            <div class="modal-body">
                <div class="form-group">
                    <div class="col-lg-12">
                        <div>
                            <div class="col-md-4"><div style="float:left">In Time : <span class="modal_in_time">00:00</span></div>   </div>
...
<script type="text/javascript">
    ...
    $(document).on('click', '.view_day_log', function () {
        ...
        var day_value = $(this).attr('day_value');

        var emp_id = $('.emp_id').val();
        $.ajax({
            url: BASE_URL + "attendance/reports/get_emp_all_logs_by_day",
            type: "POST",
            data: {user_id: emp_id, created_date: day_value, modal_in_time: modal_in_time, modal_out_time: modal_out_time},
