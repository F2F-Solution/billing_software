...
<div class="contentinner mb-125">
			...
			//$this->pre_print->view($filter);
		 	$attributes = array('class' => 'stdform editprofileform','method'=>'post');
            	...
            	<h4 class="widgettitle">Attendance Reports</h4>
                <div class="well">
                ...
                NA - Not Applicable, &nbsp; P - Permission, &nbsp; SL - Sick Leave, &nbsp; CL - Casual Leave, &nbsp; EL - Earned Leave, &nbsp; LOP - Loss of Pay, &nbsp; OD - On-duty, &nbsp; C- Compoff, &nbsp; PH - Public Holiday, &nbsp; I - Inactive Status
                </div>     
                    ...
                    <thead>
                        <tr style="height:150px;">
							...
							for($d=0;$d<=count($days_array)-1;$d++){?>
								...
								?></th>
                           <?php }?>
                            <th rowspan="3" id="rotate_padding1"><div id="rotate" class="final_cl" style="position: relative;left: 1px;">No.of&nbsp;days&nbsp;worked during&nbsp;the&nbsp;<?php if($filter["user_type"]==1) echo "week(s)"; else echo "month";?></div></th>
                            <th  rowspan="3" id="rotate_padding1"><div id="rotate">Compoff&nbsp;days&nbsp;&nbsp;&nbsp;worked</div></th>                                         
                        </tr>                                    
                            </thead>
                            <tbody>
                            <?php
                            ...
                            <td><?=ucwords($users[$k]['des_name'])?></td>                        
                              <?php  for($n=0;$n<=count($days_array)-1;$n++){
