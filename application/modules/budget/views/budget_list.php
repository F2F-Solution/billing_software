                        ...
                        foreach ($po as $val) {
                            ...
                            <tr>
                                ...
                                <td class='hide_class  action-btn-align'>
                                    ...
                                    <a href="<?php if ($this->user_auth->is_action_allowed('budget', 'budget', 'delete')): ?>#test3_<?php echo $val['id']; ?><?php endif ?>" data-toggle="modal" name="delete" class="tooltips btn btn-default btn-xs <?php if (!$this->user_auth->is_action_allowed('budget', 'budget', 'delete')): ?>alerts<?php endif ?>" title="In-Active"><span class="fa fa-ban"></span></a>
...
<!--                             <tr><td colspan="10">No data found...</td></tr>-->
                ...
                </tbody>				<tfoot>                    <tr>                        <td></td>                        <td></td>                        <td></td>                        <td class=""></td>                        <td class=""></td>                        <td class=""></td>                        <td class="text_right total-bg"></td>                        <td class="hide_class "></td>                    </tr>                </tfoot>
            </table>
