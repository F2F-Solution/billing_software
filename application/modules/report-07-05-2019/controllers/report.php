...
//            }
    ...
    function export_all_expenses_csv($query, $timezones = array()) {
        ...
        foreach ($query as $key => $value) {
            ...
            $row = array($key + 1, $value['store_name'], $value['inv_number'], $value['categoryName'], $value['product_name'], $value['brands'], $value['total_qty'], $value['net_total'], $value['return_qty'], $value['sub_total'], $value['gst'], $value['igst'], ($value['created_date'] != '1970-01-01') ? date('d-M-Y', strtotime($value['created_date'])) : '');
