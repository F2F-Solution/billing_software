        ...
        if (isset($customers) && !empty($customers)) {
            ...
            foreach ($customers as $customer) {
                ...
                <tr>
                    ...
                    <td class="text_right"><?php echo ($customer['firm_id'] == 1) ? number_format(($customer['net_total'] - $return_amt) - ($customer['electricals'] + $customer['advance']), 2) : '0'; ?></td>
                    <td class="text_right"><?php echo ($customer['firm_id'] == 2) ? number_format(($customer['net_total'] - $return_amt) - ($customer['paints'] + $customer['advance']), 2) : '0'; ?>                                    </td>
                    <td class="text_right"><?php echo ($customer['firm_id'] == 3) ? number_format(($customer['net_total'] - $return_amt) - ($customer['tiles'] + $customer['advance']), 2) : '0'; ?></td>
                    <td class="text_right"><?php echo ($customer['firm_id'] == 4) ? number_format(($customer['net_total'] - $return_amt) - ($customer['hardware'] + $customer['advance']), 2) : '0'; ?></td>
                    <td class="text_right"><?php echo ($customer['net_total'] != '') ? number_format(($customer['net_total'] - $return_amt) - ($customer['net_amount'] + $customer['advance']), 2) : '0'; ?></td>
                </tr>
                <?php
                $s++;
            }
