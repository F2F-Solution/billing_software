...
//        foreach ($query as $val) {
        ...
        foreach ($query as $val) {
            ...
            $this->db->select('SUM(sub_total) as return_amt');
...
//        $this->db->where("payment_report.inv_id !=", 'Wings Invoice');
    ...
    function get_customer_return_amt($id, $frim_id, $days_date, $due_date) {
        $this->db->select('SUM(sales_return_details.sub_total) as return_amt,sales_return_details.customer');
...
//        $this->db->where('erp_invoice.customer',1087);
    ...
    public function get_customer_based_datatables($serch_data = array()) {
        ...
        foreach ($query as $val) {
            ...
            $this->db->Select('SUM(sub_total) as return_amount');
...
//            $j++;
    ...
    function get_sales_return_list($search_data) {
        ...
        $this->db->select('sales_return_details.*,erp_category.cat_id,erp_category.categoryName,erp_product.id,erp_product.product_name,erp_brand.id,erp_brand.brands,customer.state_id,customer.store_name,erp_invoice.net_total');
    ...
    function get_all_customer_invoice_details() {
        ...
        $this->db->select('sales_return_details.*,erp_category.cat_id,erp_category.categoryName,erp_product.id,erp_product.product_name,erp_brand.id,erp_brand.brands,customer.store_name,customer.state_id,erp_invoice.net_total,customer.firm_id');
        $this->db->join('erp_category', 'erp_category.cat_id=sales_return_details.cat_id', 'left');
        $this->db->join('erp_product', 'erp_product.id=sales_return_details.product_id');
        $this->db->join('erp_brand', 'erp_brand.id=sales_return_details.brand_id', 'left');
        $this->db->join('customer', 'customer.id=sales_return_details.customer', 'left');
