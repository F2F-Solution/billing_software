...
//        $this->db->where("payment_report.inv_id !=", 'Wings Invoice');
    ...
    function get_outstanding_duedate_datatables($search_data) {
        ...
        foreach ($query as $val) {
            ...
            //$this->db->select('*');
            $this->db->select('SUM(balance) as new_balance,SUM(return_amt) as return_amt,SUM(paid_amt) as paid_amt,SUM(invoice_amt) as invoice_amt');
            ...
            //$this->db->select('*');
            $this->db->select('SUM(balance) as new_balance,return_amt,invoice_amt,paid_amt');
