                    ...
                    if (isset($all_receipt) && !empty($all_receipt)) {
                        ...
                        foreach ($all_receipt as $val) {
                            ...
                            <tr>
                                ...
                                <td  class="text_right">
                                    <?php echo ($val['net_total'] - ($val['receipt_bill'][0]['receipt_paid'] + $val['receipt_bill'][0]['receipt_discount']) > 0) ? number_format($val['net_total'] - ($val['receipt_bill'][0]['receipt_paid'] + $val['receipt_bill'][0]['receipt_discount']), 2, '.', ',') : '0.00'; ?>
                                </td>
                                <td class='action-btn-align'><?php echo ($val['receipt_bill'][0]['next_date'] != '') ? date('d-M-Y', strtotime($val['receipt_bill'][0]['next_date'])) : ''; ?></td>
                                ...
                                <td  class="hide_class action-btn-align">
                                    ...
                                    if ($val['payment_status'] == 'Pending') {
                                        ?>
                                        <a href="<?php if ($this->user_auth->is_action_allowed('purchase', 'purchase_receipt', 'edit')): ?><?php echo $this->config->item('base_url') . 'purchase_receipt/manage_receipt/' . $val['id'] ?><?php endif ?>"data-toggle="tooltip" class="tooltips btn btn-info btn-xs <?php if (!$this->user_auth->is_action_allowed('purchase', 'purchase_receipt', 'edit')): ?>alerts<?php endif ?>" title="" data-original-title="Edit"><span class="fa fa-edit "></span></a>
