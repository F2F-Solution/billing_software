        ...
        <form method="post">
            ...
            <table class="table table-striped table-bordered responsive dataTable no-footer dtr-inline">
                ...
                <tr>
                    ...
                    <td>
                        <input id='balance'  class='form-control' type='text'  style=' width:170px ;float:left;'  name='balance'   value='<?php echo ($receipt_details[0]['net_total'] - $dis) - $paid; ?>'  readonly='readonly' tabindex="1"/>
                    </td>
                </tr>
                <tr>
