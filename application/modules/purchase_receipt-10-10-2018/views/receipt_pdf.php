...
<table style="padding: 2px 2px;" row-style="page-break-inside:avoid;">
    ...
    <tr>
        ...
        <td></td>
        <td  align="center" height="30px"> <img src="<?= $theme_path; ?>/images/logo.png" alt="Chain Logo" width="125px"></td>
        <td></td>
    </tr>
    <tr>
...
<table style="padding: 2px 2px;" row-style="page-break-inside:avoid;">
    ...
    <tfoot>
        ...
        <tr>
            ...
            <td align="right"><?php echo number_format(($receipt_details[0]['net_total'] - ($receipt_details[0]['receipt_history'][0]['bill_amount'] + $receipt_details[0]['receipt_history'][0]['discount'])), 2, '.', ',') ?></td>
        </tr>
        <tr>
