...
//$options[$default] = $month_arr[$default-1];
                        ...
                        <td><input type="submit" name="go" value="Go" id="go" class="btn btn-warning border4"><?php
//                            $data = array(
//                                'name' => 'go',
                        ...
                        for ($k = 0; $k <= count($user_days) - 1; $k++) {
                            ...
                            if (isset($dol[0]["date"]) && strtotime($dol[0]["date"]) < strtotime($day_value)) {
                                ...
                                <td class="center action">
                                    ...
                                    ?>
                                    <a href='javascript:void(0)' data-toggle="tooltip" class="tooltips btn btn-default btn-xs edit" title="" data-original-title="Edit"><span class="fa fa-edit "></span></a>
                                    <?php
                                    $v = 1;
                                    ?>
                                    <a href='javascript:void(0)' class="cancel btn btn-default " data-toggle="tooltip"  title="" data-original-title="Cancel"><span class="fa fa-close "></span></a>
                                    <?php
                                    $v = 1;
                                    ?>
                                    <!--<a href='javascript:void(0)' class="cancel btn btn-danger btn-rounded">Cancel</a>-->
...
//    echo form_submit($data);
    ...
    <a href="javascript:void(0)" id="print" title="Print" class="btn btn-defaultprint6 print-align "><i class="glyphicon glyphicon-print">Print</i></a>
