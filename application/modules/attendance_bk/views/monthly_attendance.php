                            ...
                            foreach ($users as $user) {
                                ...
                                <tr class="<?= $class ?>">
                                    ...
                                    <td class="center action">
                                        ...
                                        $v = 1;
                                        ?>
                                        <a href="<?= $this->config->item('base_url') . "attendance/add_attendance/" . $user["id"] ?>" data-toggle="tooltip" class="tooltips btn btn-default btn-xs " title="" data-original-title="Add"><span class="fa fa-plus "></span></a>
