...
//  $datas['company_details'] = $this->admin_model->get_company_details();
    ...
    function ajaxList() {
        ...
        foreach ($list as $val) {
            ...
            if ($val['estatus'] != 2)
                $edit_url = '<a href="' . $url1 . '" data-toggle="tooltip" class="tooltips btn btn-default  btn-xs round' . $alert1 . '" title="" data-original-title="View"><span class="fa fa-edit"></span></a>';

            if ($val['estatus'] == 2)
                $add_url = '<a href="' . $url2 . '" data-toggle="tooltip" class="tooltips btn btn-default  btn-xs round' . $alert2 . '" title="" data-original-title="Make Invoice"><span>Make Invoice</span></a>';

            $views_url = '<a href="' . $url3 . '" data-toggle="tooltip" class="tooltips btn btn-default  btn-xs round' . $alert2 . '" title="" data-original-title="View"><span class="fa fa-log-out "> <span class="fa fa-eye"></span> </span></a>';
            ...
            if (empty($ass['invoice'])) {
                ...
                if ($ass['invoice'][0]['contract_customer'] == 0) {
                    ...
                    if ($this->user_auth->is_action_allowed('sales', 'invoice', 'edit')) {
                        ...
                        $rows = '<a href="' . $this->config->item('base_url') . 'sales/invoice_edit/' . $ass['invoice'][0]['id'] . '" data-toggle="tooltip" class="tooltips btn btn-default btn-xs" title="" ><span class="fa fa-log-out "> <span class="fa fa-edit"></span></span></a>';
                    } else {
                    ...
                    if ($this->user_auth->is_action_allowed('sales', 'invoice', 'delete')) {
                        ...
                        $row[] = $rowss . '<a href="#" data-toggle="tooltip" class="tooltips btn btn-danger btn-xs alerts" title="" ><span class="fa fa-log-out "> <span class="fa fa-ban"></span>  </span></a>';
                    }
                } else {
                    ...
                    if ($this->user_auth->is_action_allowed('sales', 'invoice', 'view')) {
                        ...
                        $rowss = '<a href="' . $this->config->item('base_url') . 'sales/invoice_views/' . $ass['invoice'][0]['id'] . '" data-toggle="tooltip" class="tooltips btn btn-default btn-xs" title="Contractor Invoice" ><span class="fa fa-log-out "> <span class="fa fa-eye"></span>  </span></a>

                            <a href="' . $this->config->item('base_url') . 'sales/invoice_views/' . $ass['invoice'][1]['id'] . '" data-toggle="tooltip" class="tooltips btn btn-default btn-xs" title="Customer Invoice" ><span class="fa fa-log-out "> <span class="fa fa-eye"></span>  </span></a>';
                    } else {
                    ...
                    if ($this->user_auth->is_action_allowed('sales', 'invoice', 'delete')) {
                        ...
                        $row[] = $rowss . '<a href="#test3_' . $ass['invoice'][0]['id'] . '" data-toggle="modal" id="yesin" name="delete" class="tooltips btn btn-danger btn-xs" ><span class="fa fa-log-out"> <span class="fa fa-ban testspan" in_id="' . $ass['invoice'][0]['id'] . '" q_id="' . $ass['invoice'][0]['q_id'] . '"></span>  </span></a>';
                    } else {
