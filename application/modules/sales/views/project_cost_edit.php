        ...
        <table class="static" style="display: none;">
            ...
            <tr>
                ...
                <td style="display:none;" >
                    ...
                    <select id='cat_id' class='form-align cat_id static_style  form-control' style="display:none;" name='categoty[]' >
...
?>
                ...
                <td class="action-btn-align cgst_td">
                    ...
                    <input type="text" tabindex="1"  tabindex="1"   name='tax[]' style="width:70px;" class="pertax" />

                </td>

                <td class="action-btn-align sgst_td">

                    <input type="text"  tabindex="1" tabindex="1"   name='gst[]' style="width:70px;" class="gst" />
    ...
    foreach ($quotation as $val) {
        ...
        ?>
                            ...
                            <tfoot>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" tabindex="1" value="<?php echo $cgst; ?>"  readonly class="add_cgst text_right" style="width:70px;" /></td>
        ...
        ?>
                    ...
                    <div>
                        ...
                        <input type="text" class="form-control class_req borderra0 terms" tabindex="1" value="<?php echo ($val['mode_of_payment'] != '') ? $val['mode_of_payment'] : '-'; ?>" name="quotation[mode_of_payment]"/>
