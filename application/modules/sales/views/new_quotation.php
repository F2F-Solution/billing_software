    ...
    <div class="contentpanel mb-45">
        ...
        <form method="post" class="panel-body" id="quotation">
            <div class="row" id="add_sales">
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" tabindex="1" class="form-control form-align datepicker required" name="quotation[created_date]" placeholder="dd-mm-yyyy" value="<?php echo date('d-m-Y'); ?>">
                            <span class="error_msg"></span>
                        </div>
                    </div>
                </div>
                ...
                <table class="table table-striped table-bordered responsive dataTable no-footer dtr-inline text-center" id="add_quotation">
                    ...
                    <tbody id='app_table'>
                        <tr>
                            ...
                            <td class="action-btn-align"><a id='delete_group' class="btn btn-default btn-xs"><span class="glyphicon glyphicon-trash"></span></a></td>
                        </tr>
                    </tbody>
                    <tbody>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" tabindex="1" name="quotation[tax]" class='totaltax text_right' style="width:100px;" />
                            </td>
                            <td></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="11">
                                ...
                                <input name="quotation[remarks]" tabindex="1" type="text" class="form-control" style="width:100%; display: inline" />
                            </td>
                        </tr>
                    </tbody>
                </table>
            ...
            <div class="action-btn-align mb-bot20">
                ...
                <button class="btn btn-primary" name="print" value="yes" id="save" tabindex="1"><span class="glyphicon glyphicon-plus"></span>Create and print</button>
            </div>
            <br />
        </form>
    </div>
...
<script type="text/javascript">
    ...
    function _load_customers(cust_id = '') {
