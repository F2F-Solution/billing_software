    ...
    <div class="contentpanel mb-45">
        ...
        <table class="static" style="display: none;">
            <tr>
                ...
                <td>
                    <input type="text"  name="model_no[]" id="model_no" tabindex="1" style="width:100%;font-weight: 600; "  class='form-align auto_customer tabwid model_no ' readonly=""/>
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            ...
                            <select name="quotation[delivery_status]"  class="form-control required form-align" id="delivery_status"   tabindex="1">
                                <option value="">Select</option>
                                <?php
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <select  name='quotation[sales_man]' class="form-control class_req" tabindex="1" id="sales_man" >
                                <option >Select</option>
                                <?php
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            ...
                            <select id='ref_class'  class='nick form-align  form-control static_style class_req required' name='quotation[ref_name]' tabindex="1"  >
                                <option value="">Select</option>
                                <?php
...
<!--                            <input type="radio" class="receiver" id="bill1" value="cash" name="cashbill"/>Cash sale
                            ...
                            <input type="radio" class="receiver" id="bill1" value="cash" name="quotation[bill_type]"/>Cash Sale
                            <input type="radio" class="receiver" id="bill2" value="credit" name="quotation[bill_type]"/>Credit Sale<br>
                    ...
                    <tbody id='app_table'>
                        <tr>
                            ...
                            <td class="action-btn-align">
                                ...
                                <div class="col-xs-4">
                                    <span class="label label-success stock_qty" style="float:right"> 0 </span></div>
                                <span class="error_msg"></span>
                            </td>
                            <td class="action-btn-align">
...
<!--                            <td class="action-btn-align">
                    ...
                    <tbody class="addtional">
                        <tr>
                            ...
                            <td class="action-btn-align"><input type="text"   name="quotation[total_qty]"   readonly="readonly" class="total_qty" style="width:70%;" id="total" /></td>
                        ...
                        <tr>
                            ...
                            <td class="action-btn-align"><input type="text" name="advance"  id="advance" readonly="readonly"  class="advance text_right" style="width:100px;" /></td>
                            <td></td>
                        </tr>
                        <tr>
                            <td colspan="4" style="width:70px; text-align:right;"></td>
                            <td colspan="4" style="text-align:right;font-weight:bold;"><input type="text"   name="quotation[tax_label]" class='tax_label text_right' style="width:100%;" /></td>
                            <td>
...
<!--                            <td>
                            ...
                            <td><input type="text" name="quotation[round_off]"  value="" class="round_off text_right" style="width:100px;" readonly=""/></td>
                            <td></td>
                        </tr>
                    </tbody>
                    <tbody class="additional" id="add_new_values">
                        <tr>
                            ...
                            <td><input type="text" name="quotation[transport]" value="" class="transport text_right" style="width:70px;" /></td>
                            <td style="text-align:right;">Labour Charge</td>
                            <td><input type="text" name="quotation[labour]" value="" class="labour text_right" style="width:70px;" /></td>
