...
<style>
    ...
    table tr td:nth-child(4) {text-align:right; }@media print {		table tr td:last-child {		border:0px solid !important; dispaly:none !important;}		table tr th:last-child {		border:0px solid !important; dispaly:none !important;}	}
            ...
            <table id="basicTable_call_back" class="table table-striped table-bordered responsive dataTable no-footer dtr-inline">
                <thead>
                    <tr>
                        ...
                        <th class='action-btn-align'>Sales Order ID</th>
                        <th class="action-btn-align">Customer Name</th>
                        <th class="action-btn-align">Sales Cost</th>
