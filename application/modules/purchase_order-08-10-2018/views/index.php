...
//                            }
            ...
            <div class="mscroll">
                <table class="table table-striped table-bordered responsive dataTable no-footer dtr-inline" id="add_quotation">
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="7" style="width:70px; text-align:right;"><b>Total</b></td>
                        ...
                        <tr>
                            ...
                            <td colspan="5" style="text-align:right;font-weight:bold;"><input type="text"  tabindex="1" name="po[tax_label]" class='tax_label text_right'    style="width:100%;" /></td>
                            <td>
