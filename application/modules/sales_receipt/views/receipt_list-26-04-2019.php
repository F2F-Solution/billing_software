...
<link rel="stylesheet" type="text/css" href="<?= $theme_path; ?>/js/auto_com/jquery.autocomplete.css" /><style>@media print {       table td:last-child {display:none !important;}       table th:last-child {display:none !important}   }   @page{ size :A4;		margin: 0;		margin: 1cm auto;}</style>
<?php
