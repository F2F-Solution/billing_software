        ...
        <form method="post">
            ...
            <table class="table table-striped table-bordered responsive dataTable no-footer dtr-inline">
                ...
                <tr>
                    ...
                    <td>
                        <input id='balance'  class='form-control' type='text'  style=' width:170px ;float:left;'  name='balance'   value='<?php echo number_format((($receipt_details[0]['payable_amt'] - $dis) - $paid) - $customer_details[0]['advance'], 2, '.', ','); ?>'  readonly='readonly' tabindex="1"/>
                    </td>
                </tr>
                <tr>
