            ...
            <table class="table table-striped table-bordered responsive dataTable no-footer dtr-inline">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input id='paid'  class='form-control dot_value full' type='text'  style=' width:170px ;float:left;'  name='receipt_bill[bill_amount]'  tabindex="1"/><div class="clearfix"></div>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type='text'  style=' width:170px ;float:left;' class="full"  class="<?php echo $class; ?>" name='receipt_bill[due_date]'  value="<?php echo $due_date ?>" <?php echo $disabled; ?> tabindex="1"/>
