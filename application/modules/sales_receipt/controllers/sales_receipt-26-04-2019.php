    ...
    function ajaxList() {
        ...
        foreach ($list as $val) {
            ...
            if ($bal > 0.00) {
                ...
                $status = '<a href="#" data-toggle="modal" class="tooltips ahref border0" title="In-Complete--' . $bal . '"><span class="fa fa-thumbs-down blue">&nbsp;</span></a>';
            } else {
                $status = '<a href="#" data-toggle="modal" class="tooltips ahref border0" title="Complete' . $bal . '"><span class="fa fa-thumbs-up green">&nbsp;</span></a>';
            }
            ...
            $edit_url = '<a href="' . $edit . '"data-toggle="tooltip" class="tooltips btn btn-default btn-xs ' . $edit_alert . '" title="" data-original-title="Edit"><span class="fa fa-edit "></span></a>';
