...
//                                    exit;
                                    ...
                                    foreach ($po_details as $vals) {
                                        ...
                                        $deliver_qty = $vals['po'][0]['delivery_qty'];
                                        ...
                                        //echo "Rajaa " . $net_total . '<br />';

                                        $over_all_net_total += $net_total;
                                        $delivery_qty_total +=$vals['po'][0]['delivery_qty'];
                                        ?>
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            ...
                                            <input type="text"   tabindex="-1"  name='quantity[]' style="width:70px;margin-top:4px;margin-bottom:4px; margin-right:6px;" class="qty" value="<?php echo $vals['po'][0]['total_qty'] ?>" readonly="readonly" />
                                            <br>
                <!--                                                <span data-toggle="tooltip" class="tooltips btn btn-success btn-xs ml-top4" style="margin-bottom:4px;margin-top:4px;" title="">Stock Quantity</span> &nbsp;
                                        ...
                                        <td>
                                            ...
                                            <input type="text"   tabindex="-1"  name='delivery_quantity[]' style="width:70px;" class="delivery_qty" value="<?php echo $vals['po'][0]['delivery_qty'] ?>" readonly="readonly"/>
                                            <br>
