...
<!--                            <td>Quotation Amount</td>-->
                            ...
                            <th class="action-btn-align">Commission Amount</th>
                            <th class="action-btn-align">Original Amount</th>
                            <th class="action-btn-align">Profit %</th>
                            <th class="action-btn-align">Profit Amount</th>
                        </tr>
                    </thead>
                    ...
                    <tbody id="result_data">
                        <?php
                        ?>
                    </tbody>											<tfoot>                        <tr>                            <td></td>                            <td></td>                            <td></td>                            <td></td>                            <td class="text_right total-bg"></td>                            <td class="text_right total-bg"></td>                            <td class="text_right total-bg"></td>                            <td class="text_right total-bg"></td>                            <td class="text_right total-bg"></td>                            <td></td>                            <td class="text_right total-bg"></td>                        </tr>                    </tfoot>							
                </table>
            </div>
