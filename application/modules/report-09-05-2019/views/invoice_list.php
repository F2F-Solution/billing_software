...
<style>
    ...
    #myDIVSHOW {
        display:none;
    }	@media print {		table {width:100%;}		margin:0 !important;	}
</style>
<?php
    ...
    <div class="contentpanel">
        <div class="panel-body mt-top5">
            <div class="result_div">
                <table id="basicTable_call_back" class="table table-striped table-bordered responsive dataTable no-footer dtr-inline invoiceid-cntr totalqua-cntr cgst-right sgst-right subtot-right invoiceamount-right paidamount-right  ">
                    <thead>
                        <tr>
                            ...
                            <th class="action-btn-align">Balance Amount</th>
                            <th class="action-btn-align">Invoice Date</th>
                            <th class="action-btn-align">Paid Date</th>
                            <th class="action-btn-align">Credit Days</th>
                            <th class="action-btn-align">Due Date</th>
                            <th class="action-btn-align">Credit Limit</th>
                            <th class="action-btn-align">Exceeded Credit Limit</th>
                    ...
                    </tbody>					<tfoot>                        <tr>                            <td></td>                            <td></td>                            <td></td>                            <td class="action-btn-align total-bg"></td>                            <td class="text_right total-bg"></td>                            <td class="text_right total-bg"></td>                            <td class="text_right total-bg"></td>                            <td class="text_right total-bg"></td>                            <td class="text_right total-bg"></td>                            <td class="text_right total-bg"></td>                            <td class="text_right total-bg"></td>                            <td></td>                            <td></td>                            <td ></td>                            <td></td>                            <td></td>                            <td></td>                            <td class=""></td>                        </tr>                    </tfoot>
                   <!-- <tfoot>
                        <tr>
                            <td colspan="4"></td>
...
<script type="text/javascript">
    ...
    $(document).ready(function ()
    {
        ...
        table = jQuery('#basicTable_call_back').DataTable({
            ...
            "columnDefs": [
                {
                    "targets": [0, 16], //first column / numbering column
