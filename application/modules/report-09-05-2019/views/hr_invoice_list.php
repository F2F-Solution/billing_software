            ...
            <div class="mscroll">
                <table id="basicTable_call_back" class="table table-striped table-bordered responsive dataTable no-footer dtr-inline result_div">
                    ...
                    <tbody>
                        ...
                        ?>
                    </tbody>					 <tfoot>                        <tr>                            <td></td>                            <td></td>                            <td></td>                            <td class="action-btn-align total-bg"></td>                            <td class="text_right total-bg"></td>                            <td class=""></td>                            <td ></td>                            <td></td>                            <td></td>                            <td class=""></td>                        </tr>                    </tfoot>
                   <!-- <tfoot>
                        <tr>
                            <td colspan="4"></td>
