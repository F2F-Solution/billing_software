...
<style>
    ...
    #myDIVSHOW {
        display:none;
    }.form-group .control-label {    margin-top: -3px;}.fs-wrap {    width: 100%;    margin: 2px 0;}
</style>
<?php
...
<div class="mainpanel">
    <div class="media mt--20">
        <div class="row">
            ...
            <div class="col-md-2">
                <input type="button" id="show" class="btn btn-info clor" value="Advance Search"  style="float:right; margin-top:9px;">
...
<script type="text/javascript">
    jQuery(document).ready(function () {
        ...
        table = jQuery('#myTable').DataTable({
            ...
            "ajax": {
                "url": "<?php echo site_url('report/ajaxList/'); ?>",
                "type": "POST",
            },
