...
@media print {		table tr td:last-child {		border:0px solid !important; dispaly:none !important;}		table tr th:last-child {		border:0px solid !important; dispaly:none !important;}	}
...
<div class="mainpanel">
    <div class="media mt--20"> <div class="row">
            ...
            <div class="col-md-2">
                <input type="button" id="show" value="Advance Search" class="btn btn-info clor" style="float:right; margin-top:9px;">
            ...
            <table id="basicTable_call_back" class="table table-striped table-bordered responsive dataTable no-footer dtr-inline
                ...
                <thead>
                    <tr>
                        ...
                        <th class="action-btn-align">Quotation No</th>
                    ...
                    if (isset($quotation) && !empty($quotation)) {
                        ...
                        foreach ($quotation as $val) {
                            ...
                            <tr>
                                ...
                                <td style="text-align:center !important;" class="action-btn-align"><?= ($val['created_date'] != '1970-01-01') ? date('d-M-Y', strtotime($val['created_date'])) : ''; ?></td>
...
<!--                             <tr><td colspan="10">No data found...</td></tr>-->
                ...
                </tbody>				<tfoot>                    <tr>                        <td></td>                        <td></td>                        <td></td>                        <td class="action-btn-align total-bg"></td>                        <td class="text_right total-bg"></td>                        <td class=""></td>                        <td class=""></td>                        <td class=" "></td>                        <td class="hide_class "></td>                    </tr>                </tfoot>
            </table>
        </div>
