            ...
            <tr>
                ...
                if ($gst_type != '') {
                    ...
                    if ($gst_type == 31) {
                        ...
                        <th class="action-btn-align  proimg-wid" >SGST%</br><span><?php echo ($search_data['gst'] && $search_data['gst'] != 'Select') ? $search_data['gst'] . '%' : ''; ?></span></th>

                    <?php } else { ?>

                        <th class="action-btn-align proimg-wid" >IGST%</br><span><?php echo ($search_data['gst'] && $search_data['gst'] != 'Select') ? $search_data['gst'] . '%' : ''; ?></span></th>
            ...
            if (isset($customer) && !empty($customer)) {
                ...
                foreach ($customer as $vals) {
                    ...
                    <tr>
                        ...
                        <td class="text_right"><?php echo $vals['tax']; ?></td>
                        <?php
                        $gst_type = $all_style[0]['state_id'];
