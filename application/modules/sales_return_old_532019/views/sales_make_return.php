        ...
        <form  action="<?php echo $this->config->item('base_url'); ?>sales_return/make_return/<?php echo $customer['customer_id']; ?>" method="post" class=" panel-body">
            ...
            <!--                                    <input type="hidden" id='cat_id' class='form-align cat_id static_style class_req form-control' name='categoty[]' readonly="" value='<?php echo $inv_details['cat_id'] ?>'>
                                ...
                                <td width=""><div class="col-md-12 sales_qty_details">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text"  tabindex="-1"   sales_qty="<?php echo $inv_details['customer_exists_qty'] ?>" name='return_quantity[]' style="width:40px;" class="qty required form-control return_qty" />
                                        </div>
                                        <span class="error_msg"></span>
                                    </div>
                                </td>
                                ...
                                <td width="">
                                    <input type="text"  tabindex="-1"  style="width:70px;" name='sub_total[]' value="<?php echo $inv_details['sub_total'] ?>" readonly="readonly" id="sub_toatl" class="subtotal text_right form-control" />
                                </td>
...
<script type="text/javascript">
    ...
    $('#save').live('click', function () {
        ...
        $('.required').each(function () {
            ...
            var tr_exists = $(this).closest('tr').attr('data-val');

            if (this_val == '' && tr_exists == "1") {
