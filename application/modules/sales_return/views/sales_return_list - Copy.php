...
<div class="mainpanel">
    ...
    <div class="media mt--20">
        ...
        <h4>Sales Return
            <p class="right">  <button class="btn btn-success topgen" title="Add Sales Return" onclick="sales_return_modal()" id="sal-inv" style="background-color:sal#ff5a92; color:#ffffff" data-toggle="modal" data-target="#sales_return_modal"><span class="glyphicon glyphicon-plus"></span>Add Sales Return </button>&nbsp;
...
=======
                            <span class="fromdate_error_msg error_msg"></span>
>>>>>>> .r5979
                        </div>
                        <span class="error_msg"></span>
                    </div>
...
||||||| .r5974
                            <span class="error_msg"></span>
=======
                            <span class="todate_error_msg error_msg"></span>
>>>>>>> .r5979
                        </div>
                        <span class="error_msg"></span>
                    </div>
...
>>>>>>> .r5979
                        ...
                        $.ajax({
                            ...
                            success: function (id) {
                                ...
                                var base_url = "<?php echo $this->config->item('base_url'); ?>";
                                window.location.href = base_url + "sales_return/make_return/" + id;
                            }
