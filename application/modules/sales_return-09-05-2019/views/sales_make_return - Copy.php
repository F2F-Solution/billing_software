...
<script type="text/javascript">
    ...
    $('#save').live('click', function () {
        ...
        $('.invoice_id_table .return_qty').each(function () {
            ...
            if (model_no.length > 0) {
                $(this).closest('tr').find('.model_no_class .error_msg').text('');
                if (Number(this_val) == '')
                {
    ...
    $('.avail_qty,.percost,.pertax,.totaltax,.return_qty,.gst,.igst,.discount').live('keyup', function () {
//    $('.qty,.percost,.pertax,.totaltax,.gst,.return_qty,.igst,.discount,.transport').live('keyup', function () {
