                ...
                <div class="panel panel-primary noborder">
                    <div class="panel-heading  panel-back  noborder">
                        ...
                        <div class="media-body1"><br />
                            <h5 class="md-title nomargin" style="color: #1e9ff2;">ABSENTIES lIST</h5>                        </div><!--<media-body >-->
                        <hr>
                        <div class="clearfix mt20">
                            <div id="parent">
                                        ...
                                        if (isset($late_users_data) && !empty($late_users_data)) {
                                            ...
                                            foreach ($late_users_data as $key => $late_list) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="st qty_align"><?php echo $late_list['in']; ?></td>
                                                    <td class="st qty_align"><?php echo $late_list['late_by']; ?></td>
                                                </tr>
                                                <?php
                                            }
                                        } else {
                                        ...
                                        if (isset($early_going_users_data) && !empty($early_going_users_data)) {
                                            ...
                                            foreach ($early_going_users_data as $key => $early_going_list) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="st qty_align"><?php echo $early_going_list['out']; ?></td>
                                                    <td class="st qty_align"><?php echo $early_going_list['early_going']; ?></td>
                                                </tr>
                                                <?php
                                            }
                                        } else {
