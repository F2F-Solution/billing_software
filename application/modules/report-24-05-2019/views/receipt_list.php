...
<div class="mainpanel">
    <div class="media mt--20">
        <div class="row">
            ...
            <div class="col-md-2">
                <input type="button" id="show" class="btn btn-info clor" value="Advance Search" style="float:right;margin-top:9px;"></input>
                ...
                <table id="myTable" class="table table-striped table-bordered responsive dataTable no-footer dtr-inline result_div
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="action-btn-align">PO #</th>
                            ...
                            <th class=" action-btn-align noExl">Payment Status</th>
                            <th class="hide_class action-btn-align noExl">Action</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
                        ...
                        if (isset($all_receipt) && !empty($all_receipt)) {
                            ...
                            foreach ($all_receipt as $val) {
                                ...
                                <tr>
                                    ...
                                    <td class=" action-btn-align payment_data">
                                        <?php
