            ...
            foreach ($po as $val) {
                        ...
                        <table class="table table-striped table-bordered responsive dataTable no-footer dtr-inline" id="add_quotation">
                            ...
                            <tbody id='app_table'>
                                ...
                                if (isset($po_details) && !empty($po_details)) {
                                    $delivery_qty_total = 0;
                                    //echo "<pre>";print_r($po_details);exit;
                                    foreach ($po_details as $vals) {
                                        $delivery_qty_total +=$vals['delivery_quantity'];
                                        ?>
                                    <input type="hidden"  name='id[]'  value='<?php echo $vals['po_details_id'] ?>'>
                                    <tr>
                                        <td>
                ...
                <!--                                                <span data-toggle="tooltip" class="tooltips btn btn-success btn-xs ml-top4" style="margin-bottom:4px;margin-top:4px;" title="">Stock Quantity</span> &nbsp;
                                        ...
                                        <td>
                                            ...
                                            <input type="text"   tabindex="-1"  name='delivery_quantity[]' style="width:70px;" class="delivery_qty" value="<?php echo $vals['delivery_quantity'] ?>" readonly="readonly"/>
                                            <br>
                                            <?php if ($vals['delivery_quantity'] == 0) { ?>
                                                ...
                                                <input type="text"   tabindex="-1"  name='return_quantity[<?php echo $vals['po_details_id'] ?>][]' style="width:70px;margin-top:4px !important;" class="return_qty" readonly="readonly"/>
                                                <span class="error_msg"></span>
                                            <?php } else { ?>
                                                <span data-toggle="tooltip" class="tooltips btn btn-success btn-xs" style="margin-bottom:4px;margin-top:4px;" title="">Return Quantity</span> &nbsp;
                                                <input type="text"   tabindex="-1"  name='return_quantity[<?php echo $vals['po_details_id'] ?>][]' style="width:70px;margin-top:4px !important;" class="return_qty" />
                                                <span class="error_msg"></span>
                                            <?php } ?>
                                        </td>
                                        <td>
