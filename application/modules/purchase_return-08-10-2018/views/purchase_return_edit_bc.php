                        ...
                        <table class="table table-striped table-bordered responsive dataTable no-footer dtr-inline" id="add_quotation">
                                        ...
                                        <tr>
                                            ...
                                            <?php if (isset($vals['stock']) && !empty($vals['stock'])) { ?>
                                                <td align="center">
                                                    ...
                                                    <input type="text"   tabindex="-1"  name='quantity[]' style="width:70px;margin-top:4px;margin-bottom:4px;" class="qty" value="<?php echo $vals['quantity'] ?>" readonly="readonly" />
                                                    <br>
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <td align="center"><input type="text"   name="po[total_qty]"  tabindex="-1" readonly="readonly" value="<?php echo $val['total_qty']; ?>" class="total_qty" style="width:70px; margin-left:-47px;" id="total" readonly="readonly"/></td>
                                ...
                                <tr>
                                    ...
                                    <td colspan="5" style="text-align:right;font-weight:bold;"><input type="text"  name="po[tax_label]" class='tax_label text_right'    style="width:70px;" value="<?php echo $val['tax_label']; ?>" readonly="readonly"/></td>
                                    <td>
...
<script type="text/javascript">
    ...
    $('#save').live('click', function () {
        ...
        $('.return_qty').each(function () {
            ...
            {
                $(this).closest('tr').find('.error_msg').text('This field less than the stock quantity').css('display', 'inline-block');
                m = 1;
            } else {
