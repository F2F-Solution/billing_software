...
//print_r($shifts);
                ...
                <!--                                                <th rowspan="2"><div class="verticalTableHeader1">OT</div></th>
                                            ...
                                            <tr>
                                                ...
                                                <th class="smallsize">S.In<br/>Time</th>

                                                <th class="smallsize">S.Out<br/>Time</th>

                                                <th class="smallsize">A.In<br/>Time</th>

                                                <th class="smallsize">A.Out<br/>Time</th>

                                                <th class="smallsize">Late<br/>By</th>

                                                <th class="smallsize">Early<br/>Going</th>

                                                <th class="smallsize">Work<br/>Duration</th>

                                                <th class="smallsize">Status</th>
