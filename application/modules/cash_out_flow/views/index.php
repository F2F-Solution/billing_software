        ...
        <div class="panel-body">
            <form action="<?php echo $this->config->item('base_url'); ?>cash_out_flow/" enctype="multipart/form-data" name="form" method="post">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text"  tabindex="1"  name="sender_name" id="sender_name" class='form-align required form-control' />
                                <span class="error_msg"></span>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text"  tabindex="1"  name="user_name" id="user_name" class='form-align required form-control' />
                                <span class="error_msg"></span>
                ...
                <div class="frameset_table action-btn-align">
                    <table>
                        <td width="570">&nbsp;</td>
                        <td><input type="submit" class="btn btn-success" value="Create" id="save" /></td>
                        <td>&nbsp;</td>
