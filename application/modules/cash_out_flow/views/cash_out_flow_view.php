        ...
        <form method="post">
            ...
            <table class="table table-striped table-bordered responsive dataTable no-footer dtr-inline">
                ...
                <tr>
                    ...
                    <td class="alignright"><?php echo date('d-M-Y', strtotime($payment[0]['created_date'])) ?></td>
                ...
                <tr>
                    ...
                    <td class="alignright"><?php echo number_format($payment[0]['cash_out'], 2, '.', ',') ?></td>
                ...
                <tr>
                    ...
                    <td class="alignright"><?php echo number_format($payment[0]['cash_in'], 2, '.', ',') ?></td>
                ...
                <tr>
                    ...
                    <td class="alignright"><?php echo number_format($payment[0]['cash_out'] - $payment[0]['cash_in'], 2, '.', ','); ?></td>
                ...
                if (isset($payment[0]['payment_history']) && !empty($payment[0]['payment_history'])) {
                    ...
                    foreach ($payment[0]['payment_history'] as $val) {
                        ...
                        <tr>
                            ...
                            <td style="text-align:right;"><?php echo $val['amount_in'] ?></td>
