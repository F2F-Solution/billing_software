...
//        exit;
    ...
    function ajaxList() {
        ...
        foreach ($list as $val) {
            ...
            $edit_url = '<a href="' . $edit . '"data-toggle="tooltip" class="tooltips btn btn-default btn-xs ' . $alert . '" title="" data-original-title="Quick pay"><span class="fa fa-edit "></span></a>';
            ...
            $delete_url = '<a href="' . $delete . '" data-toggle="modal" name="delete" class="tooltips btn btn-default btn-xs ' . $alert . '" title="Delete"><span class="fa fa-ban"></span></a>';
