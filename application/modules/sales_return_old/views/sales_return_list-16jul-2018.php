                    ...
                    <div class="filter-area-field">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4" style="position:relative;">
                                ...
                                <input type="text" placeholder="Enter Product Name" id="product_name_src" name="filter[product_name_src]" value="<?php echo $value; ?>" title="Enter product name" class="form-align form-control" ><div id="suggesstion-box_ins" class="auto-asset-search"></div>
    ...
    <!--                        <td class="action-btn-align">Total Tax</td>-->
                            ...
                            foreach ($po as $val) {
                                ...
                                <tr>
                                    ...
                                    if (isset($val['return'][1]) && !empty($val['return'][1])) {
                                        ?>
                                        <td class='action-btn-align'> <a href="<?php if ($this->user_auth->is_action_allowed('sales', 'sales_return', 'view')): ?><?php echo $this->config->item('base_url') . 'sales_return/invoice_views/' . $val['id'] ?><?php endif ?>" data-toggle="tooltip" class="tooltips btn btn-default  btn-xs <?php if (!$this->user_auth->is_action_allowed('sales', 'sales_return', 'view')): ?>alerts<?php endif ?>" title="" data-original-title="View"><?= $val['inv_id']; ?></a></td>
                                    <?php }else { ?>
            ...
            <!--                                <td class="action-btn-align"><?= $val['tax'] ?></td> -->
                                    ...
                                    <td class='hide_class  action-btn-align'>
                                        <a href="<?php if ($this->user_auth->is_action_allowed('sales', 'sales_return', 'edit')): ?><?php echo $this->config->item('base_url') . 'sales_return/po_edit/' . $val['id'] ?><?php endif ?>" data-toggle="tooltip" class="tooltips btn btn-info btn-xs <?php if (!$this->user_auth->is_action_allowed('sales', 'sales_return', 'edit')): ?>alerts<?php endif ?>" title="" data-original-title="Edit"><span>Make Return</span></a>
                                        <?php
                                        if (isset($val['return'][1]) && !empty($val['return'][1])) {
                                            ?>
                                            <a href="<?php if ($this->user_auth->is_action_allowed('sales', 'sales_return', 'view')): ?><?php echo $this->config->item('base_url') . 'sales_return/invoice_view/' . $val['id'] ?><?php endif ?>" data-toggle="tooltip" class="tooltips btn btn-default  btn-xs <?php if (!$this->user_auth->is_action_allowed('sales', 'sales_return', 'view')): ?>alerts<?php endif ?>" title="" data-original-title="View"><span class="fa fa-eye"></span></a>
                                        <?php } ?>
