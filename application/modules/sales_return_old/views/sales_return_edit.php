                ...
                <form  action="<?php echo $this->config->item('base_url'); ?>sales_return/update_po/<?php echo $val['id']; ?>" method="post" class=" panel-body">
                    ...
                    <div class="mscroll">
                        ...
                        <table class="table table-striped table-bordered responsive dataTable no-footer dtr-inline" id="add_quotation">
                                    ...
                                    foreach ($po_details as $vals) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <input type="text" tabindex="-1" class="form-align" readonly="" value='<?php echo $vals['categoryName'] ?>'>

                                            </td>

                                            <td>

                                                <input type="text" tabindex="-1" name="model_no[]" id="model_no" class='form-align auto_customer tabwid model_no required' value="<?php echo $vals['product_name']; ?>" readonly="readonly"/>
                            ...
                            <td><input type="text" tabindex="-1"  value="<?php echo $val['cgst']; ?>"  readonly class="add_cgst text_right" style="width:70px;" /></td>
                            ...
                            <tfoot>
                                ...
                                <tr>
                                    ...
                                    <td colspan="10">
                                        ...
                                        <input name="po[remarks]" tabindex="-1" type="text" class="form-control" value="<?php echo $val['remarks']; ?>"  style="width:100%; display: inline"/>
