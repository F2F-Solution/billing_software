                                        ...
                                        foreach ($firms as $val) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="action-btn-align">
                                                    ...
                                                    <a href="<?php if ($this->user_auth->is_action_allowed('masters', 'firms', 'edit')): ?><?php echo $this->config->item('base_url') . 'masters/firms/edit_firm/' . $val['firm_id'] ?><?php endif ?>" class="tooltips btn btn-default btn-xs <?php if (!$this->user_auth->is_action_allowed('masters', 'firms', 'edit')): ?>alerts<?php endif ?>" title="Edit">
...
$(document).ready(function ()
 {
var table;
      table = $("#basicTable").live("", function ()
