                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="product_name" class=" form-align required"  id="pname" maxlength="70" />
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" name="product_data" id="product_data" class="form-control">
...
<script type="text/javascript">
...

    {
        ...
        var hidin = $(this).find('.testspan').attr('id');
                    ...
                    $.ajax({
                        ...
                        success: function (result) {
...

                            {
                                ...
                                swal("Warning!", "This product has been assigned to some invoices, so you cant delete this product!!!", "warning");
