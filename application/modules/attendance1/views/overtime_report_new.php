            ...
            if(!empty($over_reports)) { 
              ...
              <tr>
                    ...
                    <td><?php echo $report_data['designation'];?></td>
                     ...
                     <?php   
                    foreach($report_data['over_time_works'] as $key1=>$over_data) { ?>
...
<div class="button_right_align">
            ...
            <a href="#" id="print" class="btn btn-warning btn-rounded print-align print_btn"><i class="glyphicon glyphicon-print"></i> Print</a>
        </div>
