...
//$options[$default] = $month_arr[$default-1];
                        ...
                        <td><input type="submit" name="go" value="Go" id="go" class="btn btn-warning border4" style="margin-left:-55px;"><?php
//                            $data = array(
//                                'name' => 'go',
...
//                            echo form_submit($data);
        ...
        <div class="panel-body mt-top5">
            ...
            <!--<table class="table table-bordered print_border print_td sortable table-striped table-bordered responsive dataTable no-footer dtr-inline tquantity-cntr tamount-right">-->
                    <thead>
                                    ...
                                    <td   class="center <?= $style ?>">
                                        ...
                                        if ($i == 1) {
                                            ...
                                            if ($attendance[$day_value]["in"] != "00:00:00")
                                                echo "<span class='time_calc'>" . $attendance[$day_value]["in"] . " - " . $attendance[$day_value]["out"] . "</span>";
                                            else
...
<div class="action-btn-align mb-10" style="margin-top:7px;">
    <input type="submit" name="update" value="save" class="btn btn-primary  save" title="save">
...
//    echo form_submit($data);
    ...
    <a href="<?= $this->config->item('base_url') . "attendance/monthly_attendance" ?>" title="Back" ><input type="button" class="btn btn-info " value="Back" id="back_btn" /></a>

    <a href="javascript:void(0)" id="print" title="Print"><input type="button" value="Print" class="btn btn-warning "/><i class="icon icon-print print_icon"></i></a>
