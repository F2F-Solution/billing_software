...
//                                    exit;
                                    ...
                                    <tr class="<?= $class ?>">
                                        ...
                                        <td class="action-btn-align"><?= $user['username'] ?></td>

                                        <td class="action-btn-align"><?= ucwords($user['first_name']) . " " . ucwords($user['last_name']) ?></td>

                                        <td class="action-btn-align"><?= ucwords($user["dept_name"]) ?></td>

                                        <td class="action-btn-align"><?= ucwords($user["des_name"]) ?></td>

                                        <td class="action-btn-align"><?= $user['email'] ?></td>

                                        <?php //if (in_array("attendance:add_attendance_for_day", $user_role)) {                    ?>
...
//                                } else {
                            ...
                            echo "<tr><td colspan='8'>Please select shift and date</td></tr>";
                        }
                        ?>
            ...
            <div class="button_right_align">
                ...
                <a href="javascript:void(0);">
                    ...
                    <input type="submit" class="action-btn-align btn btn-success"  value="Add Attendance"  name ="add_attendance" style="display:none; margin-left:50%;" id="add_attendance"/>
