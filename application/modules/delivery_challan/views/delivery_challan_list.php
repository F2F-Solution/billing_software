...
<style>
    ...
    table tr td:nth-child(11) { text-align:center !important;}@media print {		table tr td:last-child {		border:0px solid !important; dispaly:none !important;}		table tr th:last-child {		border:0px solid !important; dispaly:none !important;}	}
</style>
<?php
            ...
            <table id="basicTable_call_back" class="table table-striped table-bordered responsive dataTable no-footer dtr-inline quanty-cntr delquant-cntr totamt-right invstatus-cntr delstatus-cntr">
                <thead>
                    <tr>
                        ...
                        <th width='15%' class="action-btn-align">Firm</th>
                        <th width='10%' class="action-btn-align">Invoice No</th>
                        <th width='10%'class="action-btn-align">Customer Name</th>
                        <th width='5%' class="action-btn-align">Quantity</th>
                        <th width='5%' class="action-btn-align">Delivered Quantity</th>
                        <th width='10%' class="action-btn-align">Total Amount</th>
                        <th width='10%' class="action-btn-align">Return Quantity</th>
                        <th width='10%' class="action-btn-align">Return Amount</th>
                        <th width='10%' class="action-btn-align">Invoice Status</th>
                        <th width='10%' class="action-btn-align">Delivery Status</th>
                        <th width='10%' class="hide_class action-btn-align">Action</th>
                    </tr>
                </thead>
                <tbody>
                    <!--     <?php
