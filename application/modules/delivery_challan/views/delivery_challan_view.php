...
<style type="text/css">
    ...
    .error_msg, em{color: rgb(255, 0, 0); font-size: 12px;font-weight: normal;}table.dataTable tr td:first-child {     text-align: left; }
</style>
        ...
        if (isset($po) && !empty($po)) {
            foreach ($po as $val) {
                ...
                <table class="table table-striped table-bordered responsive dataTable no-footer dtr-inline tablecolor">
                    ...
                    <tr>
                        <td><span class="tdhead">Firm</span></td>
                    ...
                    <table class="table table-striped table-bordered responsive dataTable no-footer dtr-inline" id="add_quotation">
                        <thead>
                            <tr>
                                ...
                                <td width='10%' >Return Quantity</td>
                            ...
                            if (isset($po_details) && !empty($po_details)) {
                                foreach ($po_details as $vals) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php
                                            echo number_format($vals['return_quantity'], 2);
                                            ?></td>
                                        <td><?php
                                            echo number_format($vals['return_amount'], 2);
                                            ?></td>
                                        <td class="action-btn-align">
