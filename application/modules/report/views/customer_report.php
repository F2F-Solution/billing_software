...
<div class="mainpanel">
    ...
    <ul class="tabs">
        <li class="tab-link current hide_class" data-tab="tabs-1">Customer Invoice Report</li>
        <li class="tab-link hide_class" data-tab="tabs-2">Customer Type Chart view</li>
    </ul>
