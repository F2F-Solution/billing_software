...
<style>
    ...
    table tr td:nth-child(12) { text-align:right; }
    table tr td:nth-child(13) { text-align:right; }
    table thead {background-color: #1E9FF2; color: white; }
    #myDIVSHOW {
        display:none;
    }
</style>
...
<!--                        <td class="action-btn-align">Return Amt</td>
                        <td class="action-btn-align">Balance Amt</td>-->
