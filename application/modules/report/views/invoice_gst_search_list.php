                            ...
                            <tr>
                                ...
                                if (isset($quotation['inv_all_details']) && !empty($quotation['inv_all_details'])) {
                                    ...
                                    if (isset($quotation['inv_all_details'][$invoice_id]['in_id'])) {
                                        ...
                                        <td class="action-btn-align"><?= number_format($quotation['inv_all_details'][$invoice_id]['quantity']) ?></td>
                                ...
                                <?php } ?>
                                                                                ...
                                                                                <!--                                <td class="text_right"><?= number_format($val['return_amt'], 2, '.', ','); ?></td>
                                                                                                                <td class="text_right"><?= number_format((($val['net_total'] - $val['return_amt']) - round($val['receipt_bill'][0]['receipt_paid'] + $val['advance'] + $val['receipt_bill'][0]['receipt_discount'], 2)), 2); ?></td>-->
