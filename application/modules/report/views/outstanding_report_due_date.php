                ...
                <table id="basicTable_call_back" class="table table-striped table-bordered responsive dataTable no-footer dtr-inline result_div ob-right days1-right days2-right days3-right days4-right netbalance1-right ">
                    <thead>
                        <tr>
                            ...
                            <th>Customer Name</th>
                            <th class="action-btn-align">Mobile</th>
                            <th class="action-btn-align">OB</th>
                            <th class="action-btn-align">0 to 7 days</th>
                            <th class="action-btn-align">> 7 to 30 days</th>
                            <th class="action-btn-align">> 30 to 90 days</th>
                            <th class="action-btn-align">> 90 days</th>
                            <th class="action-btn-align">Net Balance</th>
