        ...
        <div  class="panel-body mt-top5">
            <div class="">
                <table id="basicTable_call_back" class="table table-striped table-bordered responsive dataTable no-footer dtr-inline
                       saltquq-cntr salsubtotal-right salcostamt-right "  cellspacing="0" width="100%">
                    <thead>
                        <tr>
                            <th class="action-btn-align">S.No</th>
                            <th class="action-btn-align">Sales ID</th>
                            ...
                            <th class="action-btn-align">Sales Cost Amount</th>
                            <th class="action-btn-align">Sales Cost Date</th>
                            <!--<td>Remarks</td>-->
