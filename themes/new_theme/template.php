            ...
            <div class="container">
                ...
                <div class="header-right">
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-arrow dropdown-lg pb0 purple-notify table-notify" role="menu">
                                    <div class="user-scroll today-table">
                                        <table cellpadding="0" cellspacing="0">
                                            <thead>
                                                <tr class="today-th">
                                                    <th colspan="12">Today's&nbsp;Attendance Notification</th>
                                                </tr>
                                                <tr class="today-th1">
                                                    <th rowspan="2" width="20%">Name</th>
                                                    <th colspan="5" width="40%">ForeNoon</th>
                                                    <th colspan="5" width="40%">AfterNoon</th>
                                            ...
                                            <tbody>
                                                <?php
                                                if (!empty($data['today_attenadnce'])) {
                                                    foreach ($data['today_attenadnce'] as $val) {
                                                ?>
                                                        <tr>
                                                            <td align="left"><?php echo ucfirst($val['user_name']); ?></td>
                                                            <td align="center"><?php echo $val['mor_in'] ?></td>
                                                            <td align="center"><?php echo $val['mor_out']; ?></td>
                                                            <td align="center"><?php echo $val['mor_late_by'] ?></td>
                                                            <td align="center"><?php echo $val['mor_early_going'] ?></td>
                                                            <td align="center"><?php echo $val['morning_status'] ?></td>
                                                            <td align="center"><?php echo $val['aftnun_in'] ?></td>
                                                            <td align="center"><?php echo $val['aftnun_out'] ?></td>
                                                            <td align="center"><?php echo $val['aftnun_late_by'] ?></td>
                                                            <td align="center"><?php echo $val['aftnun_early_going'] ?></td>
                                                            <td align="center"><?php echo $val['evening_status'] ?></td>
                    ...
                    <?php if ($this->user_auth->is_action_allowed('sales', 'invoice', 'add')) : ?>
                        <div class="pull-right">
                            <div class="btn-group btn-group-option but-new-inv">
                                <a href="<?php echo $this->config->item('base_url') . 'sales/new_direct_invoice' ?>" class="btn btn-success">New Invoice</a>
                            </div>
                        </div>
                    <?php endif; ?>
                ...
                <div class="menu-container">
                    <ul class="menu mb-menu">
                            ...
                            <li class="masters_tab1 <?php echo ($cur_class == 'suppliers' || $cur_class == 'customers' || $cur_class == 'firms' || $cur_class == 'user_roles' || $cur_class == 'users' || $cur_class == 'products' || $cur_class == 'categories' || $cur_class == 'brands' || $cur_class == 'reference_groups' || $cur_class == 'email_settings') ? 'active' : '' ?>"><a href="javascript: void(0)"><i class="fa fa-dashboard" aria-hidden="true"></i><span>&nbsp;Masters</span></a>
                                <ul class="sub-menu">
                                    ...
                                    <?php if ($this->user_auth->is_section_allowed('masters', 'reference_groups')) : ?>
                                        <li class="<?= ($cur_class == 'reference_groups') ? 'active' : '' ?>">
                                ...
                                <ul class="sub-menu">
                                    <?php if ($this->user_auth->is_module_allowed('purchase')) : ?>
                                        <li class="<?= ($cur_class == 'purchase_order') ? 'active' : '' ?>">
                                            <a href="<?php echo $this->config->item('base_url') . 'purchase_order/purchase_order_list' ?>">Orders</a>
                                        </li>
                                    <?php endif; ?>
                                    <?php if ($this->user_auth->is_module_allowed('purchase')) : ?>
                        ...
                        <?php if ($this->user_auth->is_module_allowed('sales')) : ?>
                            ...
                            <li class="masters_tab5 sales_tab"><a href="javascript: void(0)"><i class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></i><span>&nbsp;Sales</span></a>
                                <ul class="sub-menu">
                                    <?php if ($this->user_auth->is_module_allowed('sales')) : ?>
                                        <li class="<?= ($cur_class == 'sales' && $cur_method == 'invoice_list') ? 'active' : '' ?>"><a href="<?php echo $this->config->item('base_url') . 'sales/invoice_list' ?>"></i><span>&nbsp;Invoice</span></a>
                                        </li>
                                    <?php endif; ?>
                                    <?php if ($this->user_auth->is_module_allowed('sales')) : ?>
    ...
    <footer class="main-footer">
        <div class="container">
            <div class="copyright" id="bot_copyright">
                <div class="nvqc-show-hide-log  mt-foot">Copyright <?php echo date('Y'); ?> &COPY; Billing Software. <span class="pull-right">Powered By <a href="http://f2fsolutions.co.in/" target="_blank" style="color:#000;">F2F Solutions</a></span></div>
            </div>
        </div>
